...
# The judgment-tool coverage guard moved to tests/test_prompt_review.py on
# 2026-08-03, where the list is a BYPRODUCT of the review ledger rather than a
# second artifact maintained beside it. Two lists of one thing is the
# dead-runbook defect, and this repo has paid for that twice.
